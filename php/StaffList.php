...
$result = $link->query("SELECT * FROM hyper_staff WHERE deleted = 0 ORDER BY (career != ''), CONVERT(name USING gbk), CONVERT(career USING gbk)");
...
$result = $link->query("SELECT * FROM hyper_staff");
while ($row = $result->fetch_array()) {
